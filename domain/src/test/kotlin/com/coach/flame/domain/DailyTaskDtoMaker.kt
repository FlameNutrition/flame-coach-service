...
class DailyTaskDtoMaker {
    ...
    companion object {
        ...
        val createdBy: Property<DailyTaskDto, UUID> = newProperty()
        val owner: Property<DailyTaskDto, UUID> = newProperty()
        ...
        val DailyTaskDto: Instantiator<DailyTaskDto> = Instantiator {
            DailyTaskDto(
                ...
                createdBy = it.valueOf(createdBy, UUID.randomUUID()),
                owner = it.valueOf(owner, UUID.randomUUID()),
            )
        }
    }
