...
class GetNextClientAppointmentTest : BaseIntegrationTest() {
    ...
    @Test
    @LoadRequest(
        endpoint = "/api/appointment/client/getNext",
        httpMethod = RequestMethod.GET,
        parameters = [
            "clientIdentifier:3c5845f1-4a90-4396-8610-7261761369ae"
        ]
    )
    fun `test get next client appointment when appointments are empty`() {
