...
class GetIncomesByYearTest : BaseComponentTest() {
    ...
    fun `test get incomes aggregated by year`() {
        ...
        then(jsonResponse.getAsJsonObject("incomes").getAsJsonArray("2020-01-01")).hasSize(4)
        then(jsonResponse.getAsJsonObject("incomes").getAsJsonArray("2021-01-01")).hasSize(2)
