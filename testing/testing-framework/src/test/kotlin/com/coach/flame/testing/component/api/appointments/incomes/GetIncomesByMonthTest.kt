...
class GetIncomesByMonthTest : BaseComponentTest() {
    ...
    fun `test get incomes aggregated by month`() {

        val from = LocalDate.of(2020, 1, 1).atStartOfDay()
        val to = LocalDate.of(2021, 12, 31).atStartOfDay()
        ...
        then(jsonResponse.getAsJsonObject("incomes").getAsJsonArray("2020-01-01")).hasSize(1)
        then(jsonResponse.getAsJsonObject("incomes").getAsJsonArray("2020-02-01")).hasSize(2)
        then(jsonResponse.getAsJsonObject("incomes").getAsJsonArray("2020-05-01")).hasSize(1)
        then(jsonResponse.getAsJsonObject("incomes").getAsJsonArray("2020-07-01")).hasSize(1)
        then(jsonResponse.getAsJsonObject("incomes").getAsJsonArray("2021-02-01")).hasSize(1)
        then(jsonResponse.getAsJsonObject("incomes").getAsJsonArray("2021-05-01")).hasSize(1)
