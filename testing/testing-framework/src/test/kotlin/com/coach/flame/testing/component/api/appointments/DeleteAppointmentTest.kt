...
class DeleteAppointmentTest : BaseComponentTest() {
    ...
    @Test
    @LoadRequest(
        endpoint = "/api/appointment/delete",
    ...
    fun `test delete appointment`() {
        ...
        then(appointment1.asJsonObject.getAsJsonPrimitive("identifier").asString).isEqualTo(appointment1UUID.toString())
